package com.example.hexagonal.framework.adapter.out.kafka;

import com.example.hexagonal.application.port.NotifyEventOutputPort;
import com.example.hexagonal.framework.adapter.in.websocket.WebSocketClientAdapter;
import lombok.var;
...
public class NotifyEventKafkaAdapter implements NotifyEventOutputPort {
    ...
    private static String CLIENT_ID = "haxagonalclient";
